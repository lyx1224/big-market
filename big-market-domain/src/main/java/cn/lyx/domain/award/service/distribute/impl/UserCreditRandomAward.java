package cn.lyx.domain.award.service.distribute.impl;
...
import cn.lyx.domain.award.model.entity.UserCreditAwardEntity;
import cn.lyx.domain.award.model.valobj.AwardStateVO;
import cn.lyx.domain.award.repository.IAwardRepository;
import cn.lyx.domain.award.service.distribute.IDistributeAward;
...
/**
 * @author lyx
 * @description 发放用户积分奖品，支持 award_config 透传，满足黑名单积分奖励。
 * @since 2024/12/24
 */
