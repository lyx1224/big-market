...
import cn.lyx.infrastructure.persistent.dao.IRaffleActivityOrderDao;
import cn.lyx.infrastructure.persistent.po.RaffleActivityOrder;
...
public class RaffleActivityOrderDaoTest {
    ...
    public void test_insert() {
        RaffleActivityOrder raffleActivityOrder = new RaffleActivityOrder();
        raffleActivityOrder.setUserId("lyx");
        raffleActivityOrder.setActivityId(100301L);
        raffleActivityOrder.setActivityName("测试活动");
        raffleActivityOrder.setStrategyId(100006L);
        raffleActivityOrder.setOrderId(RandomStringUtils.randomNumeric(12));
